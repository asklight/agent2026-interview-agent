  ...
  <div class="site-shell">
    <aside class="site-sidebar">
      ...
      <nav class="site-nav" aria-label="主要导航">
        ...
        <RouterLink to="/simulation/new"><VideoCamera /><span>综合模拟</span></RouterLink>
    ...
    <div class="site-workspace">
      <header class="mobile-header">
        ...
        <nav aria-label="移动端导航">
          ...
          <RouterLink to="/simulation/new" aria-label="综合模拟"><VideoCamera /></RouterLink>
...
import { Briefcase, ChatDotSquare, Clock, Collection, DataAnalysis, HomeFilled, SwitchButton, UserFilled, VideoCamera } from '@element-plus/icons-vue'
